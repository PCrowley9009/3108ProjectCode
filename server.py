...
def replace_line(filename, linenum, text):
    ...
    if (linenum <= len(lines)):
        ...
        remove_emptyline(filename)

    else:
        print("Line ", linenum, " not in file.")
...
def handle_client(conn, addr):
    ...
    while connected: 
        ...
        if msg_length:
            ...
            if msg == "1": 
            ...
            elif msg == "2": #handles adding tickets to the user's cart
                ...
                if msg_length:
                    ...
                    lookup = msg
                    for line in users_file: #this block splits the user data (username, password, ID) into 3 different strings so that the ID can be used to access all the user's files
                        if lookup in line:
                            s1, s2, s3 = line.split(" ")
                            userID = s3.strip()
            ...
            elif msg == "3": #display what is in user's cart
                users_file = open("users.txt", "r")
                ...
                if msg_length:
                    ...
                    if os.stat(cartfilename).st_size == 0:
                        ...
                        remove_emptyline(cartfilename)
                        contents = print_file(cartfilename)
                ...
                if msg_length:
                    ...
                    replace_line(cartfilename, lineToRemove, "")
                ...
                if msg_length:
                    ...
                    if msg_length:
                        ...
                        balfile = open(balfilename, "w")
                        replace_line(balfilename, 1, newUserBal)
            ...
            elif msg == "register": #takes a user's username and password as a string and adds a randomly generated userID to the end and appends that to the users.txt file
            ...
            elif msg == "login": #authorize client to log in and see main option menu after checking that the credentials the user put in are in the users.txt file
                login_loop = True
                while login_loop:
                    users_file = open("users.txt", "r")
